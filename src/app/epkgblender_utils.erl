...
send_email(ToName, ToEmail, Subject, Message) ->
    gen_smtp_client:send({"epkgblender@pkgblender.org", [ToEmail],
        "From: pkgblender <epkgblender@pkgblender.org>\r\n"
        "To: " ++  ToName ++ " <" ++ ToEmail ++ ">\r\n"
        "Subject: [pkgblender] " ++ Subject ++ "\r\n"
        "\r\n" ++
        Message}, [{relay, "mail.pkgblender.org"}, {port, 587}]).
